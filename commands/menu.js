...
const CATEGORIES = [
  ...
  { key: 'media', icon: '🎬', title: 'MEDIA STUDIO', poem: 'the forge of moving light', cmds: ['sticker', 's', 'smeme', 'take', 'attp', 'mix', 'photo', 'toimg', 'tovideo', 'toaudio', 'cut', 'merge', 'tts', 'totext', 'transcribe', 'shazam', 'vocalremover', 'move', 'caption', 'doc', 'react', 'del', 'savesticker', 'mystickers', 'delsticker', 'autosticker'] },
